...
public static class CoreDemoData
{
    ...
    [
        ...
        new(
            ...
            "ECDSA P-256 signs long-lived partner integration tokens",
            false,
            "Partner tokens depend on elliptic curve signatures that are not post-quantum-safe.",
            "Inventory token issuers and design a hybrid signature migration plan with partner communication.",
